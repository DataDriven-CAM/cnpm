...
LDFLAGS= -Wl,-rpath,"$$ORIGIN/cpp_modules/openssl/openssl/lib":"`pwd`/cpp_modules/openssl/openssl/lib64":"`pwd`/cpp_modules/libgit2/dist/lib":"`pwd`/cpp_modules/urlcpp":"`pwd`/cpp_modules/json-thresher":"/home/roger/Software/gcc-dev/dist/lib64" -L./cpp_modules/json-thresher -L./cpp_modules/libgit2/dist/lib -L./cpp_modules/urlcpp -L./cpp_modules/openssl/openssl/lib -L./cpp_modules/openssl/openssl/lib64 -Lcpp_modules/zlib/dist/lib  -l$(libprefix)jsonthresher -l$(libprefix)urlcpp -l$(libprefix)git2 -l$(libprefix)crypto -l$(libprefix)ssl -l$(libprefix)z -Wl,--allow-multiple-definition
ifeq ($(OS),Windows_NT)
...
CXXFLAGS=-std=c++26 -DSYMBOLIC_LINK_FLAG_ALLOW_UNPRIVILEGED_CREATE=2 -DNDEBUG -O3 -I./src -I./cpp_modules/fmt/dist/include -I./cpp_modules/expected/include -I./cpp_modules/graph-v3/include -I./cpp_modules/json-thresher/include -I./cpp_modules/libgit2/dist/include -Ic:\msys64\mingw64\x86_64-w64-mingw32\include -MMD -Wl,--allow-multiple-definition
...
CXXFLAGS=-std=c++26 -DSYMBOLIC_LINK_FLAG_ALLOW_UNPRIVILEGED_CREATE=2 -DNDEBUG -O3 -fconcepts -I./src -I./cpp_modules/fmt/dist/include -I./cpp_modules/expected/include -I./cpp_modules/graph-v3/include -I./cpp_modules/json-thresher/include -I./cpp_modules/libgit2/dist/include -MMD -Wl,--allow-multiple-definition
...
CXXFLAGS=-std=c++26 -DSYMBOLIC_LINK_FLAG_ALLOW_UNPRIVILEGED_CREATE=2 -DNDEBUG -O3 -fconcepts -I./src -I./cpp_modules/fmt/dist/include -I./cpp_modules/graph-v3/include -I./cpp_modules/json-thresher/include -I./cpp_modules/libgit2/dist/include -MMD -Wl,--allow-multiple-definition
...
CXXFLAGS=-std=c++26 -DSYMBOLIC_LINK_FLAG_ALLOW_UNPRIVILEGED_CREATE=2 -DNDEBUG -O3 -fpermissive -I./src -I./cpp_modules/c-plus-plus-serializer -I./cpp_modules/urlcpp  -I./cpp_modules/openssl/openssl/include -I./cpp_modules/CLI11/include -I./cpp_modules/fmt/dist/include -I./cpp_modules/expected/include -I./cpp_modules/graph-v3/include -I./cpp_modules/json-thresher/include  -I./cpp_modules/libgit2/dist/include -MMD -Wl,--allow-multiple-definition
