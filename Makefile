...
main: build/src/npm/Initialization.o build/src/npm/Installation.o build/src/npm/Addition.o build/src/npm/Remodeler.o build/src/npm/Removal.o build/src/npm/Outdated.o build/src/npm/WebGetter.o build/src/main.o

build/src/main.o: build/src/npm/Initialization.o build/src/npm/Installation.o build/src/npm/Addition.o build/src/npm/Remodeler.o build/src/npm/Removal.o build/src/npm/Outdated.o build/src/npm/WebGetter.o
