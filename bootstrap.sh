...
#cd ../..
echo "make openssl"
#cd cpp_modules/openssl && pwd && ./config shared --prefix=`pwd`/openssl --openssldir=`pwd`/openssl/openssl && make -j3 && make install
#cd ../..
echo "make urlcpp"
#cd cpp_modules/urlcpp && mkdir -p test && pwd && make -f Makefile all
#cd ../..
